class Config:
    ...
    exclude_props = [
        ...
        *[
        ...
        'alert-description-output.children',
        'spin-custom-indicator-demo-output.children',
        'custom-skeleton-demo.children',
        'segmented-coloring-demo1.bordered',
        'segmented-coloring-demo1.controls',
        'segmented-coloring-demo1.disabled',
        'segmented-coloring-demo1.readOnly',
        'segmented-coloring-demo1.colorBlockPosition',
        'segmented-coloring-demo2-output.children',
        'copy-text-output.text'
    ]

...
demos_config = [
    {
        ...
        'description': fac.AntdParagraph(
            '默认情况下，骨架屏会监听其内部的各个组件是否处于回调函数运算输出中状态，从而自动控制加载状态的切换。'
        ),
    },
    {
        'path': 'active',
        ...
        'description': fac.AntdParagraph(
            [
                '设置参数',
                fac.AntdText('active=True', code=True),
                '为骨架屏添加动态扫屏效果。',
            ]
        ),
    },
        ...
        [
            html.Div(
                [
                    html.Div(
                        getattr(
                            views.AntdSkeleton.demos, item['path']
                        ).render(),
                        className='demo-box',
                    ),
                    html.Div(
